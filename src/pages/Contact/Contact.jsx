...
const Contact = () => {
      return (
            <div className='mx-[150px]'>
                  <h2 className='text-center text-[#009498] font-bold mt-5 mb-0  font-sans  text-[2.5rem]'>Contact</h2>
                  <hr />
                  <p className='text-center font-semibold'>Email: <span className='text-gray-500'>thedatadb@gmail.com</span></p>
