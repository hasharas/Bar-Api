...
const RandomIngredientsCart = ({ name, type, imageUrl }) => {
      return (
            ...
            <div className="flex flex-col w-auto h-full  mb-3 cursor-pointer items-center p-4 bg-slate-200 shadow-md rounded-lg transition-transform transform hover:scale-x-90">
